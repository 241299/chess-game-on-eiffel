note
	...
	author: "Generated by the New Vision2 Application Wizard. Modified by Marsel"
...
--			a_figure: EV_PIXMAP
		...
		do
			...
			create chess_world
--			create a_figure
--			a_figure.set_with_named_file (file_system.pathname_to_string (chess_img_by_figure (create {ROOK}.with_color_position ((create {CHESS_COLOR}).black, create {CHESS_POSITION}.with_xy (2, 4)))))

			create chessboard_presenter.with_view (chess_world)
			print("New game created successfully!%N")

--			chess_world.extend (create {FIGURE_MOVABLE}.create_with_image_coordinates (a_figure, 0, 0))
