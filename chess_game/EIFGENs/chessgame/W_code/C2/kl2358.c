...
extern EIF_TYPED_VALUE F2358_30673(EIF_REFERENCE);
...
EIF_TYPED_VALUE F2358_30673 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 2357, Current, 0, 0, 36099);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2357, Current, 36099);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000935, 0,0); /* Result */
